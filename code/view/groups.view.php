...
<body>
  ...
  <section class="col-lg-offset-1 col-lg-10">
    <?php foreach($data['groups'] as $group) { ?>
      <div  class="col-xs-2">
        <a href="../controler/group.ctrl.php?id=<?= $group['id'] ?>" id="pic" class="thumbnail">
          <img class="category-banner img-responsive" src="<?= $group['img'] ?>" alt="...">
          <div class="OverlayText"><?= $group['name'] ?></div>
        </a>
      </div>
    <?php } ?>
    <div  class="col-xs-2">
      <a href="../controler/group.ctrl.php?action=new" id="pic" class="thumbnail">
