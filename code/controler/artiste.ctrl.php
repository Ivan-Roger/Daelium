<?php
  ...
  if(isset($_GET['artiste']) && $_GET['artiste'] != ""){
    ...
    $data['artiste']['prenom'][0] = "Marc";
    $data['artiste']['nom'][0] = "Dupond";
    $data['artiste']['dateNaissance'][0] = "18 décembre 1878";
    $data['artiste']['email'][0] = "marc.dupond@gmail.com";
    ...
    $data['artiste']['prenom'][1] = "Laurent";
    $data['artiste']['nom'][1] = "Dupuis";
    $data['artiste']['dateNaissance'][1] = "30 janvier 1933";
    $data['artiste']['email'][1] = "laurent.dupuis@gmail.com";
    ...
    $data['artiste']['ordre'][1] = "Mr Laurent Dupuis";
